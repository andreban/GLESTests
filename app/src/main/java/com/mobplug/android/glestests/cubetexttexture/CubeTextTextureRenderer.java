...
package com.mobplug.android.glestests.cubetexttexture;
...
import com.mobplug.android.glestests.glutils.GLStringTexture;
import com.mobplug.android.glestests.glutils.Math3D;
import com.mobplug.android.glestests.glutils.MatrixStack;

public class CubeTextTextureRenderer extends AndroidGameRenderer3D<CubeTextTextureGame> {
    ...
    private GLStringTexture texture0;
    private GLFrustrum viewFrustrum;
    private MatrixStack modelViewStack;
    private MatrixStack projectionStack;
    	
	public CubeTextTextureRenderer(Context context, GLSurfaceView glSurfaceView, CubeTextTextureGame game) {
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		texture0 = new GLStringTexture(context);				
	}
