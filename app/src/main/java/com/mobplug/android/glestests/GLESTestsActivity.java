...
import com.mobplug.android.glestests.triangle.TriangleGame;
import com.mobplug.android.glestests.triangle.TriangleRenderer;
...
public class GLESTestsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GameRenderer<TriangleGame> renderer = new TriangleRenderer(this, surfaceView, game);
        gameRunnable = new BaseGameRunnable<TriangleGame>(renderer, game);
