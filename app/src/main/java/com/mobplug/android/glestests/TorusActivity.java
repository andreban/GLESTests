...
import com.mobplug.android.glestests.torus.TorusGame;
import com.mobplug.android.glestests.torus.TorusRenderer;
...
public class TorusActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TorusGame game = new TorusGame();
        GameRenderer<TorusGame> renderer = new TorusRenderer(this, surfaceView, game);
        gameRunnable = new BaseGameRunnable<TorusGame>(renderer, game);
